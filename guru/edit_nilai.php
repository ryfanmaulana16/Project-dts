    ...
    <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" min="0" name="bing" placeholder="Masukan Nilai Bahasa Ingrris" class="form-control" id="" required value="<?php echo $data['bing'] ?>">
            </div>
            <div class="form-group">
                <label for="satuan">Nilai Matematika</label>
                <input type="number" min="0" name="mtk" placeholder="Masukan Nilai Bahasa Matematika" class="form-control" id="" required value="<?php echo $data['mtk'] ?>">
            </div>
            <div class="form-group">
                <label for="harga">Nilai IPA</label>
                <input type="number" min="0" name="ipa" placeholder="Masukan Nilai IPA" class="form-control" id="" required value="<?php echo $data['ipa'] ?>">
            </div>
